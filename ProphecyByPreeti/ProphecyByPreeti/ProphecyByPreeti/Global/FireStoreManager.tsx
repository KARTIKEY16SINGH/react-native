...
export const getDocumentForCollectionWithId = (collectionName: string, id: string) => {
...
export const addDataToCollectionWithId = async (collectionName: string, id: string, data) => {
    try {
        const docRef = await addDoc(getCollectionWithId(collectionName, id), data)
        console.log("Document written with ID: ", docRef.id);
    } catch (error) {
        console.error("Error adding document: ", error);
    }
